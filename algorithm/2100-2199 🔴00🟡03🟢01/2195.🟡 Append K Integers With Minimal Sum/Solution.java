    ...
    public long minimalKSum(int[] nums, int k) {
        ...
        while (range[i] != 0 && k > 0) {
            ...
            if (cur == next) {
                ...
                i++;
                k--;
            } else if (cur + k  > next && next != 0) {
                int count = next - cur + 1;
                long res = ((long) (cur + next)) * ((long) count) / 2L;
                sum = sum + res;
                k = k - count;
                i++;
            } else {
                long res = ((long) (cur + cur + k - 1)) * ((long) k) / 2L;
                sum = sum + res;
                k = 0;
            }
            i++;
